...
const propsFile = fs.readFileSync(path.join(__dirname, '../config.properties'), 'utf-8');
const props = {};
propsFile.split('\n').forEach(line => {
...
const expectedPass = props['oficina2_password'];
...
function askPassword() {
    rl.question('Introduce la contraseña: ', (pass) => {
        if (pass === expectedPass) {
            ...
            console.log('\x1b[31mContraseña incorrecta, inténtalo de nuevo.\x1b[0m');
            askPassword();
        }
    });
}
